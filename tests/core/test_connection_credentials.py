...
from alteia.core.connection.credentials import ClientCredentials, UserCredentials
...
class TestClientCredentials(AlteiaTestBase):
    ...
    def test_initialization(self):
        ...
        client_id, client_secret = decoded_secret.split(":")
        self.assertEqual(client_id, "5aabc6df52e3ea3a3bd57a47")
        self.assertEqual(client_secret, "thesecret")
...
class TestUserCredentials(AlteiaTestBase):
    ...
    def test_initialization(self):
        ...
        self.assertEqual(client_secret, "a13497e6-3dab-45b5-b43e-dbd9089faf6a")
