...
class TestSDK(ResourcesTestBase):
    def test_resource_attributes(self):
        self.assertIsInstance(self.sdk.missions, alteia.apis.client.projectmngt.missionsimpl.MissionsImpl)
    ...
    def test_user_agent(self, *args):
        ...
        self.assertEqual(sdk._connection.user_agent, f"{sdk._name} {BASE_USER_AGENT}")

        sdk = alteia.SDK(user="username", password="password", service="service-foobar")
        self.assertEqual(sdk._connection.user_agent, f"service-foobar {sdk._name} {BASE_USER_AGENT}")
