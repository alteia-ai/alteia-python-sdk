...
class TestProjects(ResourcesTestBase):
    ...
    def test_create(self):
        ...
        self.assertDictEqual(
            ...
            {"addProjectToUsers": True, "name": "My project", "company": "COMPANY_ID"},
        )
    ...
    def test_describe(self):
        responses.add(
            "POST",
            "/project-manager/describe-project",
        ...
        responses.add(
            "POST",
            "/project-manager/describe-projects",
    ...
    def test_update_project_status(self):
        responses.add(
            "POST",
            "/project-manager/projects/update/project-id",
            body=self.__legacy_describe(),
            status=200,
            content_type="application/json",
        )

        result_project = self.sdk.projects.update_status(project="project-id", status="available")
        ...
        self.assertEqual(calls[0].request.url, "/project-manager/projects/update/project-id")
        self.assertEqual(calls[0].request.method, "POST")
        self.assertDictEqual(
            json.loads(calls[0].request.body),
    ...
    def test_delete_project(self):
        ...
        self.assertEqual(calls[0].request.url, "/project-manager/projects/project-id")
    ...
    def test_update_name(self):
        responses.add(
            "POST",
            "/project-manager/update-project-name",
