...
class TestFlights(ResourcesTestBase):
    ...
    def test_search_without_error(self):
        responses.add(
            "POST",
            "/project-manager/search-flights",
    ...
    def test_describe(self):
        responses.add(
            "POST",
            "/project-manager/describe-flight",
        ...
        responses.add(
            "POST",
            "/project-manager/describe-flights",
    ...
    def test_update_name(self):
        responses.add(
            "POST",
            "/project-manager/update-flight-name",
    ...
    def test_update_status(self):
        responses.add(
            "POST",
            "/project-manager/update-flight-status",
