...
doctest_default_flags = 0 | doctest.ELLIPSIS | doctest.NORMALIZE_WHITESPACE
...
latex_documents = [
    (
        master_doc,
        "alteia.tex",
        "Alteia Python SDK Documentation",
        "Alteia Backend Team",
        "manual",
    ),
]
...
man_pages = [(master_doc, "alteia", "Alteia Python SDK Documentation", [author], 1)]
